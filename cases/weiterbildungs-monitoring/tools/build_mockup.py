...
Ergebnis in cases/weiterbildungs-monitoring/mockup/:
...
Aufruf (aus dem Repo-Root, mit einem Klon der Knowledge Kitchen daneben):
  ...
  python3 cases/weiterbildungs-monitoring/tools/build_mockup.py ../PowerBI-Kitchen-
...
MODEL = {
    "source": "Weiterbildungs-Monitoring (Trainingsmodell, cases/weiterbildungs-monitoring)",
    "tables": [
        ...
        {"name": "_Measures", "desc": "Kennzahlen (skripte/dax/measures.dax)", "columns": [], "measures": [
