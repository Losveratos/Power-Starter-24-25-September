...
Kein eigenes Modell zur Hand? Nimm das **Rad-&-Tat-Modell aus Tag 2** ([Übungen](uebungen/tag2.md)),
...
Die Zahlen kannst du gegen [`daten/kontrollzahlen.json`](daten/kontrollzahlen.json) prüfen.
