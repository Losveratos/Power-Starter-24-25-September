...
Die **fertige Lösung** zum Fall [`cases/weiterbildungs-monitoring`](../../cases/weiterbildungs-monitoring/) als
Power-BI-Projekt (PBIP): Modell mit allen Abfragen, Beziehungen und Measures plus die Berichtsseite „Überblick"
nach dem [Mockup](../../cases/weiterbildungs-monitoring/mockup/page-1-uberblick.png).
...
| `_Measures` | 29 Measures in 4 Ordnern | [`measures.dax`](../../cases/weiterbildungs-monitoring/skripte/dax/measures.dax) |
...
Alle Zahlen: [`kontrollzahlen.json`](../../cases/weiterbildungs-monitoring/daten/kontrollzahlen.json).

## Wie es gebaut und geprüft wurde

Erzeugt mit [`tools/pbip/build_weiterbildung_pbip.py`](../../tools/pbip/build_weiterbildung_pbip.py), ohne Handarbeit an den Dateien:
...
- Mit Claude Code in diesem Repo weiterbauen: z. B. `powerbi-design-framework` für ein Theme nach Firmen-CI oder
  `chartkitchen-report`, um die Karten und Varianzen mit ChartKitchen zu zeichnen (siehe [skills.md](../../skills.md)).
