...
Ergebnis (in 03-Fall-Weiterbildung/Daten/):
  1-Rohdaten/weiterbildung_buchungen_2025.csv   LMS-Export, absichtlich unordentlich (Windows-1252, ;, deutsche Zahlen)
  2-Anreicherung/*.csv                          Dimensionen (UTF-8, sauber)
  3-Ziele/ziele_2025.xlsx + *.csv               Ziele als Kreuztabellen (Budget je Quartal, Zielwerte je Kennzahl)
  kontrollzahlen.json                             alle Zahlen, die in der Anleitung vorkommen

Deterministisch (fester Seed). Aufruf aus dem Repo-Root:
  python3 _Werkzeuge/fall-weiterbildung/generate_data.py
...
D_ROH = CASE / "Daten" / "1-Rohdaten"
D_ANR = CASE / "Daten" / "2-Anreicherung"
D_ZIEL = CASE / "Daten" / "3-Ziele"
YEAR = 2025
