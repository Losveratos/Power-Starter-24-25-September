...
_Werkzeuge/kontrollzahlen-tag1-tag2.json und werden in den Übungen zitiert.

Aufruf (aus dem Repo-Root):  python3 _Werkzeuge/tag-daten_erzeugen.py
...
OUT1 = ROOT / "01-Tag-1" / "Daten"
OUT2 = ROOT / "02-Tag-2" / "Daten"
YEAR = 2025
...
def main():
    ...
    (ROOT / "_Werkzeuge" / "kontrollzahlen-tag1-tag2.json").write_text(
